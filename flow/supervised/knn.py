...
class KNN(CellClassifier):
    """
    Implement a K Nearest Neighbours classifier for the purpose of predicting cell classification in cytometry data
    """
    ...
    def build_model(self, **kwargs) -> None:
        ...
        -----------
        kwargs:
            additional keyword arguments for KNeighborsClassifier (see sklearn documentation)
