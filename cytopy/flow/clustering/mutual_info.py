...
def mutual_info(a: List[int],
                b: List[int],
                method: str):
    methods = {"adjusted": adjusted_mutual_info_score,
...
class MutualInfo:
    def __init__(self,
        ...
        self.data = pd.DataFrame(columns=list(self.labels.keys()),
                                 index=list(self.labels.keys()))
    ...
    def plot_matrix(self,
        ...
        return sns.clustermap(data=self.data,
