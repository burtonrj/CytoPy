...
class SupportVectorMachine(CellClassifier):
    """
    Implement a Support Vector Machine for the purpose of predicting cell classification in cytometry data
    """
    ...
    def build_linear(self, **kwargs) -> None:
        ...
        Parameters
        -----------
        kwargs: additional keyword arguments for LinearSVC (see sklearn documentation)
    ...
    def build_nonlinear(self,
                        kernel: str or callable = 'poly',
                        cache_size: float = 4000, **kwargs) -> None:
        """
        ...
        Parameters
        -----------
        kernel: str or callable, (defauly='poly')
            kernel type to be used by the algorithm, must be one of ‘linear’, ‘poly’, ‘rbf’, ‘sigmoid’,
            or a function (custom kernel).
        cache_size: float, (default=4000)
            Size of kernel cache (default = 4000 MB)
        kwargs:
            additional keyword arguments for SVC (see sklearn documentation)
