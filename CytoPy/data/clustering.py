...
def valid_directory(path: str):
    """
    Check if directory is valid. Raises ValidationError if invalid.
    Parameters
    ----------
    path: path to directory for checking

    Returns
    -------
    """
    if not os.path.isdir(path):
        raise mongoengine.errors.ValidationError(f"{path} is not a valid directory")
